//Author: Amber Bhatt
//Student Number: 97792105
//Lab Section: L1O
//Date: December 2, 2018
//Purpose: The purpose of this code is to create a Simon Game that will read the users input via clicking the buttons
//to see if the user entered the same LED values that were generated by the random generator. This will dictate the win and
//lose conditions. Whether the user entered the correct sequence (win) or the incorrect sequence (lose) to the one generated.
